...
export const __PATH = {
  ...
  user_equipment: path.join(
    __dirname,
    "/resources/data/birth/xiuxian/equipment"
  ),
  ...
  generate_exchange: path.join(
    __dirname,
    "/resources/data/birth/xiuxian/exchange"
  ),
...
class DateIndex {
  constructor() {
    ...
    /** 生成jsoon数据 */
    genertate.talent_list = JSON.parse(
      fs.readFileSync(`${__PATH.fixed_talent}/talent_list.json`)
    );
