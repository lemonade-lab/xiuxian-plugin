            ...
            if (action != null) {
                ...
                if (action.Place_action == "0") {
                    ...
                    if (now_time > end_time) {
                        ...
                        variable = await Xiuxian.Numbers(variable);
                        variable = variable - 1;
                        ...
                        if (Data_battle.victory == player_id) {
                            ...
                            if (random1 <= x) {
                                ...
                                let najie = await Xiuxian.Read_najie(player_id);player_id
                                if (searchsthing.class == 1) {
                                    ...
                                    najie = await Xiuxian.Add_najie_thing_danyao(najie, searchsthing, 1);
                                }
                                ...
                                await Xiuxian.Write_najie(player_id, najie);
                            }
                            else {
                            ...
                            if(player.lingshi>=2){
                                ...
                                await Xiuxian.Add_lingshi(player_id, -10000);
                            }else{
