...
export class moneyoperation extends plugin {
    ...
    async Give_lingshi(e) {
        ...
        var cost = config.getconfig("xiuxian", "xiuxian").percentage.cost;
        ...
        let transferTimeout = parseInt(config.getconfig("xiuxian", "xiuxian").CD.transfer * 60000)
    ...
    async uer_honbao(e) {
        ...
        lastgetbung_time = parseInt(lastgetbung_time);
        let transferTimeout = parseInt(config.getconfig("xiuxian", "xiuxian").CD.honbao * 60000)
