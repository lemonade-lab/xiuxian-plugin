            ...
            if (action != null) {
                ...
                if (action.xijie == "-2") {
                    ...
                    if (now_time >= end_time) {
                        ...
                        let npc_damage = Math.trunc(Harm(B_player.攻击 * 0.85, A_player.防御) + Math.trunc(B_player.攻击 * B_player.法球倍率) + B_player.防御 * 0.1);
                        let last_msg = "";
                        if (Random < 0.1) {
                        ...
                        if (A_player.当前血量 > 0) {
                            ...
                            const xx = "【全服公告】" + A_player.名号 + "被" + B_player.名号 + "抓进了地牢,希望大家遵纪守法,引以为戒";
