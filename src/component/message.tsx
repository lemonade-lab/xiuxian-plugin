    ...
    <div className="level">
      <div className="level-box">
        ...
        <div className="level-box-item">
          <img className="nav-box-item-img" src={require('../../resources/svg/attack.svg')} />
          <span>{attack}</span>
          <span className="level-box-item-font">{`(+${+data.base
            .attack})`}</span>
        </div>
        <div className="level-box-item">
          <img className="nav-box-item-img" src={require('../../resources/svg/defense.svg')} />
          <span>{`${defense}`}</span>
        ...
        <div className="level-box-item">
          <img className="nav-box-item-img" src={require('../../resources/svg/blood.svg')} />
          <span>{`${blood}`}</span>
          <span className="level-box-item-font">
            {`(+${data.base.blood})`}
          </span>
        ...
        <div className="level-box-item">
          <img className="nav-box-item-img" src={require('../../resources/svg/agile.svg')} />
          <span>{`${agile}`}</span>
        </div>
        <div className="level-box-item">
          <img
