...
function getDefenseById(id: number) {
  if (id < 13) {
    ...
    return BaseLevel.attack * id * 4 * 0.4
  } else if (25 <= id && id < 29) {
    return BaseLevel.attack * id * 5 * 0.5
  } else if (29 <= id && id < 33) {
    return BaseLevel.attack * id * 6 * 0.6
  } else if (33 <= id && id < 37) {
    return BaseLevel.attack * id * 7 * 0.7
  } else if (37 <= id && id < 46) {
    return BaseLevel.attack * id * 10 * 0.8
  } else {
    return 0
  }
}
